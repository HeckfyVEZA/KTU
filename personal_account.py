...
if authentication_status: 
    ...
    Data_frame = pd.read_excel('C:\\Users\\kushhov\\Desktop\\\personal_account\\test_table.xlsx') #Оригинальная выгрузка
    ...
    auth_frame = pd.read_excel('C:\\Users\\kushhov\\Desktop\\\personal_account\\origin_table.xlsx') #Первоначальная выгрузка
